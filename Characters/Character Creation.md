...
### Quick Reflexes
Once per combat, when an enemy declares an Attack or effect that includes you as a target (before any Attack roll or effect resolution), you move a number of metres equal to your Walk Travel Rate + Grace in metres at Speed 14. You count as targeted at the moment the enemy declares intent, even if the effect also targets other creatures or areas.

### Craftsman
You can repair broken gear twice as fast and create simple items given time and materials.

### Intimidating Presence
Once per Rest, force an enemy to make a DN 16 Resolve Test or be Frightened for 1d4 Rounds.
...
Level 0 characters are slightly trained civilians. Combat is rarely the right answer. Encounters are lopsided. Mistakes are punished. The Hollowdeep does not scale to your party.
