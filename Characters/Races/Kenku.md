...
## Mimic Speech
You can perfectly mimic any voice you have heard. Creatures may make an Insight Test against DN (10 + your Negotiation modifiers) to discern the mimicry.

## Low Light Vision
Your clear zone extends into what would normally be your blurry zone up to 9m. You cannot see in total darkness.

## Talon Strike
As an attack, you may use your claws to deal 1d4 + Grace Slashing damage at Speed 14 + Grace.

## Glide
When falling, for every 2m you fall you may move 1m horizontally. You take no falling damage on landing regardless of height, provided you have sufficient horizontal space to glide into.
...
Prerequisites: None. 
Cost: 2 Trait Point. 
Attacks made against creatures that cannot see you deal +1 damage.

## Improved Silent Strike 
Prerequisites: Silent Strike. 
Cost: 1 Trait Point. 
Attacks made against creatures that cannot see you deal +1 additional damage, increasing the total bonus to +2.
...
Prerequisites: None. 
Cost: 2 Trait Points. 
As a Half Action, you produce a mimicked sound or voice to disorient a target within hearing range. The target must make a Resolve Test against DN 10 + your Negotiation modifier. On failure, they gain Dazed until the end of their next turn. No usage limit.

## Environmental Mimicry
Prerequisites: Mimic Confusion.
Cost: 2 Trait Points. 
Your mimicry extends beyond voices to non-vocal sounds — footsteps, weapon draws, doors, environmental noise. The sound still originates from you. This expands the utility of Mimic Confusion and Mimic Speech to include these sounds.

## Enhanced Glide
Prerequisites: None. 
Cost: 2 Trait Points. 
Your glide efficiency improves. For every 1.5m you fall you may move 1m horizontally.

## Mastered Glide
Prerequisites: Enhanced Glide. 
Cost: 2 Trait Points. 
Your glide efficiency improves further. For every 1m you fall you may move 1m horizontally.

## Wing Dash
Prerequisites: Mastered Glide. Exclusive to Wingbeat. 
Cost: 3 Trait Points
As a Full Action, you generate a powerful burst of force with your wings, propelling yourself up to 5m in a straight line along the ground in any direction. You may choose to dash any distance up to the maximum. If you travel at least 1m and make a melee attack immediately after, the attack deals an additional 1d6 damage.

## Swift Wing Dash
Prerequisites: Wing Dash.
Cost: 2 Trait Points. Wing Dash now costs a Half Action instead of a Full Action.

## Wingbeat
Prerequisites: Mastered Glide. Exclusive to Wing Dash. 
Cost: 3 Trait Points. 
As a Half Action, you drive your wings downward in a single powerful beat, launching yourself vertically up to 10m. This functions as its own movement type and follows standard action rules for jumping — repeating requires re-initiating.