...
Affects **information and accuracy**, not action economy.
### Stunned
...
- Your **Sturdiness** is ignored; your effective **Evasion becomes 0**.
...
Vulnerable affects **damage intake**, not accuracy or action economy.
### Exhaustion (1-10)
...
| **3–4**          | **-1 to all Action Speed values.** (Your Actions resolve slightly later in the round.)                              |
| **5–6**          | **-2 to all Action Speed values.** (You begin noticeably slowing and reacting late.)                                |
| **7–8**          | **Lose 1 Full Action** each round. (You now have only 1 Full Action + your Half Action.)           |
| **9**            | **Lose 1 Full Action** each round, and your **Speed penalty becomes -3.** (You are barely functional.) |
...
- You **lose your Half Action**** on your next turn.
### Slowed
...
- Melee **Attack** Tests against you are at **Disadvantage**.
