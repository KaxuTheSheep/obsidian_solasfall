...
- **Block does not immediately occur** when declared.  
    The **first time** your Block prevents [[Damage Types|damage]] this [[Rounds|round]], it resolves using its **Block [[Speed & Resolution|Speed]]**.
## Block [[Speed & Resolution|Speed]]
When Block is actually used (i.e., the moment an [[Attacks|attack]] makes contact):
- Resolve Block at the **[[Speed & Resolution|Speed]] of the weapon or shield** being used to Block.
- If blocking unarmed, use your **Unarmed [[Speed & Resolution|Speed]]**.
If multiple blocking tools are available (weapon + shield):
- You choose which one determines the **[[Speed & Resolution|Speed]]** when the Block is triggered.
If an [[Attacks|attack]] hits your block before its activates properly, you instead use half of your **Block Value**. 
