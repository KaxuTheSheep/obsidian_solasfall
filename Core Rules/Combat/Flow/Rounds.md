...
The number and type of actions a character may take during the Round are defined by that character’s action economy.

## Resolution Phase
After all declarations are made, the Round is resolved.
Actions resolve in order of **Speed**, with **higher Speed finishing earlier**.  
