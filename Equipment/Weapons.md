...
**Special — Bleeding & Sturdiness Pierce:** When a Kris deals damage that reduces a target’s **Sturdiness** to 0, you may choose to cause **Bleeding**. If you choose to cause Bleeding, ignore **1 point** of the target’s Sturdiness on that hit (i.e., reduce effective Sturdiness by 1 for damage resolution). Bleeding from Kris is thematic and relatively weak (low-severity, cumulative).
